...
| sbref | Single-band b0 reference for the DWI volume in Nifti format (fmap)|
...
| rev_sbref | Single-band b0 reference for the reverse-phase DWI volume in Nifti format (fmap)|
